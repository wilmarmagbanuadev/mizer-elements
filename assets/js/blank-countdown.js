( function ( $ ) {
  ...
  */  
  BlankCountdown = {
      ...
      */
      _calculateTime: function( wrapper, scope_id ) {
          ...
          var time_run = Cookies.get( 'be-time-to-run-' + scope_id );
          var distance = time_run - currentTime;
          var countdown_animation_miliseconds = countdown_animation * 60000;

          Cookies.set( 'be-timer-distance-' + scope_id, distance, { path: '/' } );
          ...
          if( distance > 0 ) {
              BlankCountdown._countdownTime( distance, wrapper, scope_id );
          } else {
              ...
              BlankCountdown._expireAction( action, wrapper, scope_id );
          }
      ...
      */
      _countdownTime: function( distance, wrapper, scope_id ) {
          ...
          Cookies.set( 'be-timer-days-' + scope_id, days, { path: '/' } );
          Cookies.set( 'be-timer-hours-' + scope_id, hours, { path: '/' } );
          Cookies.set( 'be-timer-minutes-' + scope_id, minutes, { path: '/' } );
          Cookies.set( 'be-timer-seconds-' + scope_id, seconds, { path: '/' } );

          BlankCountdown._countDisplay( 
              Cookies.get( 'be-timer-days-' + scope_id ), 
              Cookies.get( 'be-timer-hours-' + scope_id ), 
              Cookies.get( 'be-timer-minutes-' + scope_id ), 
              Cookies.get( 'be-timer-seconds-' + scope_id ), 
          wrapper, scope_id );

          $( '.elementor-element-' + scope_id ).find( '.be-item' ).css( 'display', 'flex' );
          $( '.elementor-element-' + scope_id ).find( '.be-countdown-separator' ).css( 'display', 'flex' );

          $( '.elementor-element-' + scope_id + ' .be-countdown-show-seconds-no' ).find( '.be-countdown-seconds' ).css( 'display', 'none' );
          $( '.elementor-element-' + scope_id + ' .be-countdown-show-seconds-no' ).find( '.be-countdown-minutes-separator' ).css( 'display', 'none' );

          $( '.elementor-element-' + scope_id + ' .be-countdown-show-minutes-no' ).find( '.be-countdown-minutes' ).css( 'display', 'none' );
          $( '.elementor-element-' + scope_id + ' .be-countdown-show-minutes-no' ).find( '.be-countdown-hours-separator' ).css( 'display', 'none' );

          $( '.elementor-element-' + scope_id + ' .be-countdown-show-hours-no' ).find( '.be-countdown-hours' ).css( 'display', 'none' );
          $( '.elementor-element-' + scope_id + ' .be-countdown-show-hours-no' ).find( '.be-countdown-days-separator' ).css( 'display', 'none' );

          $( '.elementor-element-' + scope_id + ' .be-countdown-show-days-no' ).find( '.be-countdown-days' ).css( 'display', 'none' );
          $( '.elementor-element-' + scope_id + ' .be-countdown-show-days-no' ).find( '.be-countdown-days-separator' ).css( 'display', 'none' );
      },
      /**
       * Display the timer.
       *
      ...
      _expireAction: function( action, wrapper, scope_id ) {
          ...
          switch ( action ) {
              ...
              case 'show_message':
                  ...
                  if ( elementorFrontend.isEditMode() ){
                      BlankCountdown._countdownTime( 0, wrapper, scope_id );
                      $( '.elementor-element-' + scope_id + ' .be-preview-message' ).find( '.be-item' ).css( 'display', 'none' );
                      $( '.elementor-element-' + scope_id + ' .be-preview-message' ).find( '.be-countdown-separator' ).css( 'display', 'none' );                      
                  }
                  else {
                      wrapper.find( '.be-item' ).css( 'display', 'none' );
                      wrapper.find( '.be-countdown-separator' ).css( 'display', 'none' );
                      wrapper.find( '.be-expire-message-wrapper' ).css( 'display', 'block' );
                      wrapper.find( '.be-countdown-items-wrapper' ).css( 'max-width', '100%' );
                  } 
              ...
              case 'reset': 
                  BlankCountdown._initEvergreen( wrapper, scope_id );
                  BlankCountdown._evergreenTimer( wrapper, scope_id );

                  countdownInterval[ scope_id ] = setInterval( function() { 
                      BlankCountdown._calculateTime( wrapper, scope_id );           
                  }, 1000);
      ...
      _initEvergreen : function( wrapper, scope_id ) {
          ...
          Cookies.set( 'be-timer-cdTime-' + scope_id, cd_time, { path: '/' } );  
          Cookies.set( 'be-timer-evgInt-' + scope_id, interval, { path: '/' } ); 
          Cookies.set( 'be-timer-firstTime-' + scope_id, evg_now, { path: '/' } );

          return Cookies.get( 'be-timer-cdTime-' + scope_id ); 
      },
      /**
      ...
      _evergreen: function( wrapper, scope_id ) {
          ...
          if ( !Cookies.get( 'be-timer-cdTime-' + scope_id ) && !Cookies.get( 'be-timer-evgInt-' + scope_id ) ) {
              return BlankCountdown._initEvergreen( wrapper, scope_id );
          }

          if ( Cookies.get( 'be-timer-cdTime-' + scope_id ) && Cookies.get( 'be-timer-evgInt-' + scope_id ) != interval ) {
              return BlankCountdown._initEvergreen( wrapper, scope_id );
          }
      ...
      _evergreenTimer: function( wrapper, scope_id ) {
          ...
          var currentTime = ( new Date ).getTime();
          var usedTime = currentTime - Cookies.get( 'be-timer-firstTime-' + scope_id ); 
          var cntTime =  BlankCountdown._evergreen( wrapper, scope_id );;
          var runTimer = cntTime - usedTime;
          
          clearInterval( countdownInterval[ scope_id ] );
          Cookies.set( 'be-time-to-run-' + scope_id, runTimer, { path: '/' } );
      },
      /**
      ...
      _fixedTimer :function( wrapper, scope_id ) {
          ...
          Cookies.set( 'be-time-to-run-' + scope_id, time_to_run, { path: '/' } );
      },
      /**
      ...
      _recurringTimer :function( wrapper, scope_id ) {
          ...
          resetInterval[ scope_id ] = setInterval( function() {
              ...
              if( 0 == rem_minutes && 0 == rem_seconds){
                  wrapper.removeClass( 'be-countdown-hide' );
                  BlankCountdown._initEvergreen( wrapper, scope_id );
                  BlankCountdown._evergreenTimer( wrapper, scope_id );
              }
  ...
  var WidgetBlankCountdown = function( $scope, $ ) {
      ...
      var wrapper = $scope.find( '.be-countdown-wrapper' );
      ...
      if( !Cookies.get( 'be-timer-firstTime-' + scope_id ) && !Cookies.get( 'be-timer-cdTime-' + scope_id ) ){
      ...
      if( 'evergreen' == type ){
          ...
          clearInterval( countdownInterval[ scope_id ] );
          BlankCountdown._fixedTimer( wrapper, scope_id );
      }else{
          clearInterval( countdownInterval[ scope_id ] );
          BlankCountdown._recurringTimer( wrapper, scope_id );
      }
      ...
      if( Cookies.get( 'be-timer-days-' + scope_id ) && Cookies.get( 'be-timer-hours-' + scope_id ) && Cookies.get( 'be-timer-minutes-' + scope_id ) && Cookies.get( 'be-timer-seconds-' + scope_id )){
          BlankCountdown._countDisplay( Cookies.get( 'be-timer-days-' + scope_id ), Cookies.get( 'be-timer-hours-' + scope_id ), Cookies.get( 'be-timer-minutes-' + scope_id ), Cookies.get( 'be-timer-seconds-' + scope_id ), wrapper, scope_id );
      }
  };

  $( window ).on( 'elementor/frontend/init', function () {
      elementorFrontend.hooks.addAction( 'frontend/element_ready/blank-countdown.default', WidgetBlankCountdown );
  });
